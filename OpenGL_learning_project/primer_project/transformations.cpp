...
int main()
{
	...
	Shader ourShader("shaders/transformation.vs", "shaders/transformation.fs");//使用着色器类简化
	...
	while (!glfwWindowShouldClose(window))//check the exit request
	{
		...
		//glm::mat4 trans;
		//trans = glm::rotate(trans, glm::radians(90f), glm::vec3(0.0, 0.0, 1.0)); //glm::radians(90.0f)不如直接90.0f来的快
		//trans = glm::scale(trans, glm::vec3(0.5, 0.5, 0.5));
		glm::mat4 trans;
		trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f));
		trans = glm::rotate(trans, (float)glfwGetTime() * 180 / 3.141592654f, glm::vec3(0.0f, 0.0f, 1.0f));
